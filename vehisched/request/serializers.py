...
class RequestOfficeStaffSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['request_id', 'requester_last_name', 'requester_first_name', 'requester_middle_name', 
                  'travel_date', 'travel_time', 'return_date', 'return_time','destination', 'office_or_dept', 'number_of_passenger', 
                  'passenger_names', 'purpose', 'is_approved', 'status', 'vehicle', 'created_at', 'driver_name', 'category', 'sub_category', 'distance']